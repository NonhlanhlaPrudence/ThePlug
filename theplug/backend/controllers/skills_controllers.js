...
router.post("/default_skills", async (req, res, next) => {
    ...
    let skills =   
    [
        {name:"Laundry"},{name:"Cooking"},{name:"Painting"},
        {name:"Cleaning"},{name:"Driving"},{name:"Paving"},
        {name:"Washing dishes"},{name:"Washing laundry"},{name:"Bricklaying"},
        {name:"Handyman"},{name:"Helper"},{name:"Typing"},
        {name:"Gardening"},{name:"Photographer"},{name:"Designing"},
        ...
        {name:"Tracking personal finances"},{name:"Catering"},{name:"Unclogging a toilet "},
        ...
        {name:"People management"},{name:"Presentation"},{name:"Reporting"},
        {name:"Hunting"},{name:"Baby sitting"},{name:"Porter"},
        {name:"Refinishing furniture"},{name:"Troubleshooting"},{name:"Observation"},{name:"Participation"},
    ]; 
